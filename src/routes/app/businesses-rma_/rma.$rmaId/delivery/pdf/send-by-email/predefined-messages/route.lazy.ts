...
export const Route = createLazyFileRoute('/app/businesses-rma_/rma/$rmaId/delivery/pdf/send-by-email/predefined-messages')({
  component: AppViewRmaViewDeliveryViewPdfModalViewSendByEmailModalViewPredefinedMessagesModalView,
});
