...
export const Route = createLazyFileRoute('/app/businesses-rma_/rma/$rmaId/support/pdf/send-by-email/predefined-messages')({
  component: AppViewRmaViewSupportViewPdfModalViewSendByEmailModalViewPredefinedMessagesModalView,
});
