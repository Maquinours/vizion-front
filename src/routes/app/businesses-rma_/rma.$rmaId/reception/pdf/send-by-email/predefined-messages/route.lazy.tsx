...
export const Route = createLazyFileRoute('/app/businesses-rma_/rma/$rmaId/reception/pdf/send-by-email/predefined-messages')({
  component: AppViewRmaViewReceptionViewPdfModalViewSendByEmailModalViewPredefinedMessagesModalView,
});
