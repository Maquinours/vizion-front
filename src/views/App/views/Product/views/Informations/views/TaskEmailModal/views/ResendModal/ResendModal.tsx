...
const routeApi = getRouteApi('/app/products_/$productId/informations/task-email/$taskId/resend');

export default function AppViewProductViewInformationsViewTaskEmailModalViewResendModalView() {
