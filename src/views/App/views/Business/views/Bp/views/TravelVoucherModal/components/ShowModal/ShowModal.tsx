...
type AppViewBusinessViewBpViewTravelVoucherModalViewShowModalComponentProps = {
  show: boolean;
  onClose: () => void;
  data: Array<File> | undefined;
};
export default function AppViewBusinessViewBpViewTravelVoucherModalViewShowModalComponent({
  show,
  onClose,
  data,
}: AppViewBusinessViewBpViewTravelVoucherModalViewShowModalComponentProps) {
