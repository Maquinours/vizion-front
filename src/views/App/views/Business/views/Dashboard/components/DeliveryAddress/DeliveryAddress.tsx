...
type AppViewBusinessViewDashboardViewDeliveryAddressComponentProps = Readonly<{
  register: UseFormRegister<BusinessDashboardFormType>;
  errors: FieldErrors<BusinessDashboardFormType>;
}>;
export default function AppViewBusinessViewDashboardViewDeliveryAddressComponent({
  register,
  errors,
