              ...
              {task && (
                <MenuList>
                  {!task.businessId && !task.enterpriseId && !task.productId && !task.rmaId && (
                    <MenuItem>
                      <Link from={Route.id} to="./link-personal-task/$taskId" params={{ taskId: task.id }} search={(old) => old} preload="intent" replace>
                  ...
                  {task.state !== TaskState.ARCHIVED && (
                    <MenuItem>
                      <Link from={Route.id} to="./archive-personal-task/$taskId" params={{ taskId: task.id }} search={(old) => old} preload="intent" replace>
                  ...
                  {![TaskState.CLOSED, TaskState.ARCHIVED].includes(task.state!) && (
                    <MenuItem>
                      <Link from={Route.id} to="./validate-personal-task/$taskId" params={{ taskId: task.id }} search={(old) => old} preload="intent" replace>
                  ...
                  <MenuItem>
                    <Link from={Route.id} to="./personal-task-details/$taskId" params={{ taskId: task.id }} search={(old) => old} preload="intent" replace>
