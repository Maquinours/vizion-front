...
const routeApi = getRouteApi('/app/businesses-rma_/business/$businessId_/assistance/$assistanceId/delete-lifesheet/$lifesheetId');

export default function AppViewAssistanceViewDeleteLifesheetModalView() {
