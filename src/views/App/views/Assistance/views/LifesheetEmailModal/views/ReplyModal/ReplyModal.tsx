...
const routeApi = getRouteApi('/app/businesses-rma_/business/$businessId_/assistance/$assistanceId/lifesheet-email/$lifesheetId/reply');

export default function AppViewAssistanceViewLifesheetEmailModalViewReplyModalView() {
