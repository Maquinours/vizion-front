...
export default function AppViewStudyViewAutomaticViewFooterComponentStepTwoComponentPdfModalComponent({
  ...
  return (
    <ReactModal
      ...
      className="absolute top-2/4 left-2/4 z-2005 m-auto h-auto -translate-x-2/4 -translate-y-2/4 rounded-[5px] bg-[#fbfcfe] p-0 opacity-100 shadow-[0px_3px_5px_#10173526]"
