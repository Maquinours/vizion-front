...
export type AppViewStudyViewExpertViewFlowComponentComponentHelperLinesComponentProps = {
...
export default function AppViewStudyViewExpertViewFlowComponentComponentHelperLinesComponent({
  horizontal,
  vertical,
}: AppViewStudyViewExpertViewFlowComponentComponentHelperLinesComponentProps) {
