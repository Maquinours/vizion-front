...
import AppViewStudyViewExpertViewProductsMenuComponentProductSelectComponent from './components/ProductSelect/ProductSelect';
    ...
    <div className="space-y-2 border-r border-r-slate-800">
      ...
      <div id="product_categories_block" className="space-y-2 px-4">
        <>
          ...
          <AppViewStudyViewExpertViewProductsMenuComponentProductSelectComponent />
        </>
      </div>
    </div>
  );
