...
export type CreateMailFormType = yup.InferType<typeof yupSchema>;

type AppViewToolsViewMailsViewCreateModalViewFormModalComponentProps = Readonly<{
  show: boolean;
  onClose: () => void;
  onSubmit: (data: CreateMailFormType) => void;
}>;
export default function AppViewToolsViewMailsViewCreateModalViewFormModalComponent({
  show,
  onClose,
  onSubmit,
}: AppViewToolsViewMailsViewCreateModalViewFormModalComponentProps) {
