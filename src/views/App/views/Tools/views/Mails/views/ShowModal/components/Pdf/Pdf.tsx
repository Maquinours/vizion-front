...
type AppViewToolsViewMailsViewShowModalViewPdfComponentProps = Readonly<{
  mail: MailPaperResponseDto;
}>;
export default function AppViewToolsViewMailsViewShowModalViewPdfComponent({ mail }: AppViewToolsViewMailsViewShowModalViewPdfComponentProps) {
  return (
        ...
        <View>
          ...
          <View style={pageStyles.sectionOne}>
            ...
            <View style={pageStyles.gridTwo}>
              <Text style={pageStyles.contact}>{mail.enterpriseName}</Text>
              <Text style={pageStyles.contact}>{mail.profileName}</Text>
              <Text style={pageStyles.address}>{mail.addressLineOne}</Text>
              <Text style={pageStyles.address}>{mail.addressLineTwo}</Text>
          ...
          <View style={pageStyles.sectionThree}>
            <Text>Objet: {mail.subject}</Text>
            <Text>Référence: {mail.reference}</Text>
          </View>

          <View style={pageStyles.date}>
            <Text>Villeurbanne, le {format(new Date(mail.createdDate!), 'cccc, dd/MM/yyyy', { locale: fr })}</Text>
          </View>

          <View style={pageStyles.sectionFour}>
            {Object.values(mail.content).map((item, index) => (
          ...
          <View wrap={false} style={pageStyles.sectionFive}>
            <View style={pageStyles.signature}>
              ...
              <Text wrap={false}>{mail.profileSenderName}</Text>
              <Text wrap={false}>{mail.profileSenderEmail}</Text>
