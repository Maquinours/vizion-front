...
const routeApi = getRouteApi('/app/enterprises_/$enterpriseId/delete-lifesheet/$lifesheetId');

export default function AppViewEnterpriseViewDeleteLifesheetModalView() {
