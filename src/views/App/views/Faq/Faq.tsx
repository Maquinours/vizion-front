...
export default function AppViewFaqView() {
  const { page, archived, search, productId, accessLevel, fuzzy, titleOnly } = routeApi.useSearch();

  const { data, isLoading } = useQuery(faqs.page({ page, size })._ctx.byArchiveStateAndSearch(archived, search, productId, accessLevel, fuzzy, titleOnly));
