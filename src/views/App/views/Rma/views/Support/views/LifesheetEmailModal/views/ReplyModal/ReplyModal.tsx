...
const routeApi = getRouteApi('/app/businesses-rma_/rma/$rmaId/support/lifesheet-email/$lifesheetId/reply');

export default function AppViewRmaViewSupportViewLifesheetEmailModalViewReplyModalView() {
