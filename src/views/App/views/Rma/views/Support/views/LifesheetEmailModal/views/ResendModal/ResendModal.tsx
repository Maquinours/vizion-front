...
const routeApi = getRouteApi('/app/businesses-rma_/rma/$rmaId/support/lifesheet-email/$lifesheetId/resend');

export default function AppViewRmaViewSupportViewLifesheetEmailModalViewResendModalView() {
