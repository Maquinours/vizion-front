...
const AuthForgotPasswordRouteLazyImport = createFileRoute('/auth/forgot-password')();
const AuthResetPasswordTokenRouteLazyImport = createFileRoute('/auth/reset-password/$token')();
const AppFaqCreateRouteLazyImport = createFileRoute('/app/faq/create')();
const AppDashboardCreateProgressiveInfoRouteLazyImport = createFileRoute('/app/dashboard/create-progressive-info')();
const AppDashboardCreateCollectiveTaskRouteLazyImport = createFileRoute('/app/dashboard/create-collective-task')();
const AppToolsSchedulerCreateRouteLazyImport = createFileRoute('/app/tools/scheduler/create')();
const AppToolsPredefinedTextsCreateRouteLazyImport = createFileRoute('/app/tools/predefined-texts/create')();
const AppToolsPredefinedMessagesCreateRouteLazyImport = createFileRoute('/app/tools/predefined-messages/create')();
const AppToolsNewsCreateRouteLazyImport = createFileRoute('/app/tools/news/create')();
const AppToolsExternalLinksCreateRouteLazyImport = createFileRoute('/app/tools/external-links/create')();
const AppToolsEmailsSendRouteLazyImport = createFileRoute('/app/tools/emails/send')();
const AppToolsEmailsEmailIdRouteLazyImport = createFileRoute('/app/tools/emails/$emailId')();
const AppToolsDdnsCreateRouteLazyImport = createFileRoute('/app/tools/ddns/create')();
const AppEnterprisesEnterpriseIdUpdateAccountabilityRouteLazyImport = createFileRoute('/app/enterprises/$enterpriseId/update-accountability')();
const AppEnterprisesEnterpriseIdImportContactsRouteLazyImport = createFileRoute('/app/enterprises/$enterpriseId/import-contacts')();
const AppEnterprisesEnterpriseIdDeleteRouteLazyImport = createFileRoute('/app/enterprises/$enterpriseId/delete')();
const AppEnterprisesEnterpriseIdCreateLifesheetCommentRouteLazyImport = createFileRoute('/app/enterprises/$enterpriseId/create-lifesheet-comment')();
const AppEnterprisesEnterpriseIdCreateContactRouteLazyImport = createFileRoute('/app/enterprises/$enterpriseId/create-contact')();
const AppToolsSchedulerDetailsRdvIdRouteLazyImport = createFileRoute('/app/tools/scheduler/details/$rdvId')();
const AppToolsPredefinedMessagesUpdatePredefinedMessageIdRouteLazyImport = createFileRoute('/app/tools/predefined-messages/update/$predefinedMessageId')();
const AppToolsPredefinedMessagesDeletePredefinedMessageIdRouteLazyImport = createFileRoute('/app/tools/predefined-messages/delete/$predefinedMessageId')();
const AppToolsEmailsEmailIdReplyRouteLazyImport = createFileRoute('/app/tools/emails/$emailId/reply')();
const AppProductsProductIdManageCreateVersionRouteLazyImport = createFileRoute('/app/products/$productId/manage/create-version')();
const AppEnterprisesEnterpriseIdTaskEmailTaskIdRouteLazyImport = createFileRoute('/app/enterprises/$enterpriseId/task-email/$taskId')();
const AppEnterprisesEnterpriseIdRenameGedObjectObjectRelativePathRouteLazyImport = createFileRoute(
  '/app/enterprises/$enterpriseId/rename-ged-object/$objectRelativePath',
)();
const AppEnterprisesEnterpriseIdDeleteGedObjectObjectRelativePathRouteLazyImport = createFileRoute(
  '/app/enterprises/$enterpriseId/delete-ged-object/$objectRelativePath',
)();
const AppEnterprisesEnterpriseIdAddressBookCreateRouteLazyImport = createFileRoute('/app/enterprises/$enterpriseId/address-book/create')();
const AppDashboardTaskEmailTaskIdReplyRouteLazyImport = createFileRoute('/app/dashboard/task-email/$taskId/reply')();
const AppToolsSchedulerDetailsRdvIdUpdateRouteLazyImport = createFileRoute('/app/tools/scheduler/details/$rdvId/update')();
const AppToolsSchedulerDetailsRdvIdDeleteRouteLazyImport = createFileRoute('/app/tools/scheduler/details/$rdvId/delete')();
const AppFaqGedFaqIdRenameItemRelativePathRouteLazyImport = createFileRoute('/app/faq/ged/$faqId/rename/$itemRelativePath')();
const AppFaqGedFaqIdDeleteItemRelativePathRouteLazyImport = createFileRoute('/app/faq/ged/$faqId/delete/$itemRelativePath')();
const AppEnterprisesEnterpriseIdTaskEmailTaskIdReplyRouteLazyImport = createFileRoute('/app/enterprises/$enterpriseId/task-email/$taskId/reply')();
const AppProductsProductIdInformationsTaskEmailTaskIdReplyRouteLazyImport = createFileRoute('/app/products/$productId/informations/task-email/$taskId/reply')();
...
const AuthLoginRouteLazyRoute = AuthLoginRouteLazyImport.update({
  path: '/login',
  getParentRoute: () => AuthRouteRoute,
} as any).lazy(() => import('./routes/auth/login/route.lazy').then((d) => d.Route));

const AuthForgotPasswordRouteLazyRoute = AuthForgotPasswordRouteLazyImport.update({
  path: '/forgot-password',
  getParentRoute: () => AuthRouteRoute,
} as any).lazy(() => import('./routes/auth/forgot-password/route.lazy').then((d) => d.Route));
...
const AppProductsRouteRoute = AppProductsRouteImport.update({
  path: '/products',
  getParentRoute: () => AppRouteRoute,
} as any).lazy(() => import('./routes/app/products/route.lazy').then((d) => d.Route));
...
const AppExternalLinksRouteRoute = AppExternalLinksRouteImport.update({
  path: '/external-links',
  getParentRoute: () => AppRouteRoute,
} as any).lazy(() => import('./routes/app/external-links/route.lazy').then((d) => d.Route));

const AppEnterprisesRouteRoute = AppEnterprisesRouteImport.update({
  path: '/enterprises',
  getParentRoute: () => AppRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises/route.lazy').then((d) => d.Route));

const AppDashboardRouteRoute = AppDashboardRouteImport.update({
  path: '/dashboard',
  getParentRoute: () => AppRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/route.lazy').then((d) => d.Route));

const AuthResetPasswordTokenRouteLazyRoute = AuthResetPasswordTokenRouteLazyImport.update({
  path: '/reset-password/$token',
  getParentRoute: () => AuthRouteRoute,
} as any).lazy(() => import('./routes/auth/reset-password.$token/route.lazy').then((d) => d.Route));

const AppFaqCreateRouteLazyRoute = AppFaqCreateRouteLazyImport.update({
  path: '/create',
  getParentRoute: () => AppFaqRouteRoute,
} as any).lazy(() => import('./routes/app/faq/create/route.lazy').then((d) => d.Route));

const AppDashboardCreateProgressiveInfoRouteLazyRoute = AppDashboardCreateProgressiveInfoRouteLazyImport.update({
  path: '/create-progressive-info',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/create-progressive-info/route.lazy').then((d) => d.Route));

const AppDashboardCreateCollectiveTaskRouteLazyRoute = AppDashboardCreateCollectiveTaskRouteLazyImport.update({
  path: '/create-collective-task',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/create-collective-task/route.lazy').then((d) => d.Route));

const AppToolsSchedulerRouteRoute = AppToolsSchedulerRouteImport.update({
  path: '/scheduler',
  getParentRoute: () => AppToolsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/scheduler/route.lazy').then((d) => d.Route));

const AppToolsRepresentativesTurnoverRouteRoute = AppToolsRepresentativesTurnoverRouteImport.update({
  path: '/representatives-turnover',
  getParentRoute: () => AppToolsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/representatives-turnover/route.lazy').then((d) => d.Route));

const AppToolsPredefinedTextsRouteRoute = AppToolsPredefinedTextsRouteImport.update({
  path: '/predefined-texts',
  getParentRoute: () => AppToolsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/predefined-texts/route.lazy').then((d) => d.Route));

const AppToolsPredefinedMessagesRouteRoute = AppToolsPredefinedMessagesRouteImport.update({
  path: '/predefined-messages',
  getParentRoute: () => AppToolsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/predefined-messages/route.lazy').then((d) => d.Route));

const AppToolsNewsRouteRoute = AppToolsNewsRouteImport.update({
  path: '/news',
  getParentRoute: () => AppToolsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/news/route.lazy').then((d) => d.Route));

const AppToolsExternalLinksRouteRoute = AppToolsExternalLinksRouteImport.update({
  path: '/external-links',
  getParentRoute: () => AppToolsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/external-links/route.lazy').then((d) => d.Route));

const AppToolsEmailsRouteRoute = AppToolsEmailsRouteImport.update({
  path: '/emails',
  getParentRoute: () => AppToolsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/emails/route.lazy').then((d) => d.Route));

const AppToolsDdnsRouteRoute = AppToolsDdnsRouteImport.update({
  path: '/ddns',
  getParentRoute: () => AppToolsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/ddns/route.lazy').then((d) => d.Route));

const AppProductsProductIdRouteRoute = AppProductsProductIdRouteImport.update({
  path: '/products/$productId',
  getParentRoute: () => AppRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/route.lazy').then((d) => d.Route));

const AppProductsSerialNumbersRouteRoute = AppProductsSerialNumbersRouteImport.update({
  path: '/serial-numbers',
  getParentRoute: () => AppProductsRouteRoute,
} as any).lazy(() => import('./routes/app/products/serial-numbers/route.lazy').then((d) => d.Route));

const AppExternalLinksExternalLinkIdRouteRoute = AppExternalLinksExternalLinkIdRouteImport.update({
  path: '/external-links/$externalLinkId',
  getParentRoute: () => AppRouteRoute,
} as any).lazy(() => import('./routes/app/external-links_.$externalLinkId/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdRouteRoute = AppEnterprisesEnterpriseIdRouteImport.update({
  path: '/enterprises/$enterpriseId',
  getParentRoute: () => AppRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/route.lazy').then((d) => d.Route));

const AppDashboardDeleteCollectiveTasksRouteRoute = AppDashboardDeleteCollectiveTasksRouteImport.update({
  path: '/delete-collective-tasks',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/delete-collective-tasks/route.lazy').then((d) => d.Route));

const AppDashboardCreatePersonalTaskRouteRoute = AppDashboardCreatePersonalTaskRouteImport.update({
  path: '/create-personal-task',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/create-personal-task/route.lazy').then((d) => d.Route));
...
const AppToolsSchedulerCreateRouteLazyRoute = AppToolsSchedulerCreateRouteLazyImport.update({
  path: '/create',
  getParentRoute: () => AppToolsSchedulerRouteRoute,
} as any).lazy(() => import('./routes/app/tools/scheduler/create/route.lazy').then((d) => d.Route));

const AppToolsPredefinedTextsCreateRouteLazyRoute = AppToolsPredefinedTextsCreateRouteLazyImport.update({
  path: '/create',
  getParentRoute: () => AppToolsPredefinedTextsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/predefined-texts/create/route.lazy').then((d) => d.Route));

const AppToolsPredefinedMessagesCreateRouteLazyRoute = AppToolsPredefinedMessagesCreateRouteLazyImport.update({
  path: '/create',
  getParentRoute: () => AppToolsPredefinedMessagesRouteRoute,
} as any).lazy(() => import('./routes/app/tools/predefined-messages/create/route.lazy').then((d) => d.Route));

const AppToolsNewsCreateRouteLazyRoute = AppToolsNewsCreateRouteLazyImport.update({
  path: '/create',
  getParentRoute: () => AppToolsNewsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/news/create/route.lazy').then((d) => d.Route));

const AppToolsExternalLinksCreateRouteLazyRoute = AppToolsExternalLinksCreateRouteLazyImport.update({
  path: '/create',
  getParentRoute: () => AppToolsExternalLinksRouteRoute,
} as any).lazy(() => import('./routes/app/tools/external-links/create/route.lazy').then((d) => d.Route));

const AppToolsEmailsSendRouteLazyRoute = AppToolsEmailsSendRouteLazyImport.update({
  path: '/emails/send',
  getParentRoute: () => AppToolsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/emails_.send/route.lazy').then((d) => d.Route));

const AppToolsEmailsEmailIdRouteLazyRoute = AppToolsEmailsEmailIdRouteLazyImport.update({
  path: '/$emailId',
  getParentRoute: () => AppToolsEmailsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/emails/$emailId/route.lazy').then((d) => d.Route));

const AppToolsDdnsCreateRouteLazyRoute = AppToolsDdnsCreateRouteLazyImport.update({
  path: '/create',
  getParentRoute: () => AppToolsDdnsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/ddns/create/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdUpdateAccountabilityRouteLazyRoute = AppEnterprisesEnterpriseIdUpdateAccountabilityRouteLazyImport.update({
  path: '/update-accountability',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/update-accountability/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdImportContactsRouteLazyRoute = AppEnterprisesEnterpriseIdImportContactsRouteLazyImport.update({
  path: '/import-contacts',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/import-contacts/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdDeleteRouteLazyRoute = AppEnterprisesEnterpriseIdDeleteRouteLazyImport.update({
  path: '/delete',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/delete/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdCreateLifesheetCommentRouteLazyRoute = AppEnterprisesEnterpriseIdCreateLifesheetCommentRouteLazyImport.update({
  path: '/create-lifesheet-comment',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/create-lifesheet-comment/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdCreateContactRouteLazyRoute = AppEnterprisesEnterpriseIdCreateContactRouteLazyImport.update({
  path: '/create-contact',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/create-contact/route.lazy').then((d) => d.Route));

const AppProductsProductIdManageRouteRoute = AppProductsProductIdManageRouteImport.update({
  path: '/manage',
  getParentRoute: () => AppProductsProductIdRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/manage/route.lazy').then((d) => d.Route));

const AppProductsProductIdInformationsRouteRoute = AppProductsProductIdInformationsRouteImport.update({
  path: '/informations',
  getParentRoute: () => AppProductsProductIdRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/informations/route.lazy').then((d) => d.Route));

const AppProductsSerialNumbersCreateRouteRoute = AppProductsSerialNumbersCreateRouteImport.update({
  path: '/create',
  getParentRoute: () => AppProductsSerialNumbersRouteRoute,
} as any).lazy(() => import('./routes/app/products/serial-numbers/create/route.lazy').then((d) => d.Route));

const AppFaqUpdateFaqIdRouteRoute = AppFaqUpdateFaqIdRouteImport.update({
  path: '/update/$faqId',
  getParentRoute: () => AppFaqRouteRoute,
} as any).lazy(() => import('./routes/app/faq/update.$faqId/route.lazy').then((d) => d.Route));

const AppFaqSendByEmailFaqIdRouteRoute = AppFaqSendByEmailFaqIdRouteImport.update({
  path: '/send-by-email/$faqId',
  getParentRoute: () => AppFaqRouteRoute,
} as any).lazy(() => import('./routes/app/faq/send-by-email.$faqId/route.lazy').then((d) => d.Route));

const AppFaqGedFaqIdRouteRoute = AppFaqGedFaqIdRouteImport.update({
  path: '/ged/$faqId',
  getParentRoute: () => AppFaqRouteRoute,
} as any).lazy(() => import('./routes/app/faq/ged.$faqId/route.lazy').then((d) => d.Route));

const AppFaqDeleteFaqIdRouteRoute = AppFaqDeleteFaqIdRouteImport.update({
  path: '/delete/$faqId',
  getParentRoute: () => AppFaqRouteRoute,
} as any).lazy(() => import('./routes/app/faq/delete.$faqId/route.lazy').then((d) => d.Route));

const AppFaqArchiveFaqIdRouteRoute = AppFaqArchiveFaqIdRouteImport.update({
  path: '/archive/$faqId',
  getParentRoute: () => AppFaqRouteRoute,
} as any).lazy(() => import('./routes/app/faq/archive.$faqId/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdUpdateRepresentativeRouteRoute = AppEnterprisesEnterpriseIdUpdateRepresentativeRouteImport.update({
  path: '/update-representative',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/update-representative/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdUpdateCategoryRouteRoute = AppEnterprisesEnterpriseIdUpdateCategoryRouteImport.update({
  path: '/update-category',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/update-category/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdUpdateRouteRoute = AppEnterprisesEnterpriseIdUpdateRouteImport.update({
  path: '/update',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/update/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdImportGedFilesRouteRoute = AppEnterprisesEnterpriseIdImportGedFilesRouteImport.update({
  path: '/import-ged-files',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/import-ged-files/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdCreateGedDirectoryRouteRoute = AppEnterprisesEnterpriseIdCreateGedDirectoryRouteImport.update({
  path: '/create-ged-directory',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/create-ged-directory/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdAddressBookRouteRoute = AppEnterprisesEnterpriseIdAddressBookRouteImport.update({
  path: '/address-book',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/address-book/route.lazy').then((d) => d.Route));

const AppEnterprisesUpdateContactContactIdRouteRoute = AppEnterprisesUpdateContactContactIdRouteImport.update({
  path: '/update-contact/$contactId',
  getParentRoute: () => AppEnterprisesRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises/update-contact.$contactId/route.lazy').then((d) => d.Route));

const AppEnterprisesUpdateContactPasswordContactIdRouteRoute = AppEnterprisesUpdateContactPasswordContactIdRouteImport.update({
  path: '/update-contact-password/$contactId',
  getParentRoute: () => AppEnterprisesRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises/update-contact-password.$contactId/route.lazy').then((d) => d.Route));

const AppEnterprisesSendEmailToContactContactIdRouteRoute = AppEnterprisesSendEmailToContactContactIdRouteImport.update({
  path: '/send-email-to-contact/$contactId',
  getParentRoute: () => AppEnterprisesRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises/send-email-to-contact.$contactId/route.lazy').then((d) => d.Route));

const AppEnterprisesDeleteContactContactIdRouteRoute = AppEnterprisesDeleteContactContactIdRouteImport.update({
  path: '/delete-contact/$contactId',
  getParentRoute: () => AppEnterprisesRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises/delete-contact.$contactId/route.lazy').then((d) => d.Route));

const AppEnterprisesCreateEnterpriseRmaEnterpriseIdRouteRoute = AppEnterprisesCreateEnterpriseRmaEnterpriseIdRouteImport.update({
  path: '/create-enterprise-rma/$enterpriseId',
  getParentRoute: () => AppEnterprisesRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises/create-enterprise-rma.$enterpriseId/route.lazy').then((d) => d.Route));

const AppEnterprisesCreateContactEnterpriseIdRouteRoute = AppEnterprisesCreateContactEnterpriseIdRouteImport.update({
  path: '/create-contact/$enterpriseId',
  getParentRoute: () => AppEnterprisesRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises/create-contact.$enterpriseId/route.lazy').then((d) => d.Route));

const AppEnterprisesCreateContactTravelVoucherContactIdRouteRoute = AppEnterprisesCreateContactTravelVoucherContactIdRouteImport.update({
  path: '/create-contact-travel-voucher/$contactId',
  getParentRoute: () => AppEnterprisesRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises/create-contact-travel-voucher.$contactId/route.lazy').then((d) => d.Route));

const AppEnterprisesCreateContactBusinessContactIdRouteRoute = AppEnterprisesCreateContactBusinessContactIdRouteImport.update({
  path: '/create-contact-business/$contactId',
  getParentRoute: () => AppEnterprisesRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises/create-contact-business.$contactId/route.lazy').then((d) => d.Route));

const AppDashboardValidatePersonalTaskTaskIdRouteRoute = AppDashboardValidatePersonalTaskTaskIdRouteImport.update({
  path: '/validate-personal-task/$taskId',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/validate-personal-task.$taskId/route.lazy').then((d) => d.Route));

const AppDashboardUpdateProgressiveInfoProgressiveInfoIdRouteRoute = AppDashboardUpdateProgressiveInfoProgressiveInfoIdRouteImport.update({
  path: '/update-progressive-info/$progressiveInfoId',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/update-progressive-info.$progressiveInfoId/route.lazy').then((d) => d.Route));

const AppDashboardUpdatePersonalTaskDeadlineTaskIdRouteRoute = AppDashboardUpdatePersonalTaskDeadlineTaskIdRouteImport.update({
  path: '/update-personal-task-deadline/$taskId',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/update-personal-task-deadline.$taskId/route.lazy').then((d) => d.Route));

const AppDashboardTransferTaskTaskIdRouteRoute = AppDashboardTransferTaskTaskIdRouteImport.update({
  path: '/transfer-task/$taskId',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/transfer-task.$taskId/route.lazy').then((d) => d.Route));

const AppDashboardTaskEmailTaskIdRouteRoute = AppDashboardTaskEmailTaskIdRouteImport.update({
  path: '/task-email/$taskId',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/task-email.$taskId/route.lazy').then((d) => d.Route));

const AppDashboardTaskCommentsTaskIdRouteRoute = AppDashboardTaskCommentsTaskIdRouteImport.update({
  path: '/task-comments/$taskId',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/task-comments.$taskId/route.lazy').then((d) => d.Route));

const AppDashboardTakeCollectiveTaskTaskIdRouteRoute = AppDashboardTakeCollectiveTaskTaskIdRouteImport.update({
  path: '/take-collective-task/$taskId',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/take-collective-task.$taskId/route.lazy').then((d) => d.Route));

const AppDashboardSchedulerEventDetailsEventIdRouteRoute = AppDashboardSchedulerEventDetailsEventIdRouteImport.update({
  path: '/scheduler-event-details/$eventId',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/scheduler-event-details.$eventId/route.lazy').then((d) => d.Route));

const AppDashboardPersonalTaskDetailsTaskIdRouteRoute = AppDashboardPersonalTaskDetailsTaskIdRouteImport.update({
  path: '/personal-task-details/$taskId',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/personal-task-details.$taskId/route.lazy').then((d) => d.Route));

const AppDashboardOtherPersonalTasksProfileIdRouteRoute = AppDashboardOtherPersonalTasksProfileIdRouteImport.update({
  path: '/other-personal-tasks/$profileId',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/other-personal-tasks.$profileId/route.lazy').then((d) => d.Route));

const AppDashboardLinkPersonalTaskTaskIdRouteRoute = AppDashboardLinkPersonalTaskTaskIdRouteImport.update({
  path: '/link-personal-task/$taskId',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/link-personal-task.$taskId/route.lazy').then((d) => d.Route));

const AppDashboardDeleteProgressiveInfoProgressiveInfoIdRouteRoute = AppDashboardDeleteProgressiveInfoProgressiveInfoIdRouteImport.update({
  path: '/delete-progressive-info/$progressiveInfoId',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/delete-progressive-info.$progressiveInfoId/route.lazy').then((d) => d.Route));

const AppDashboardDeleteCollectiveTaskTaskIdRouteRoute = AppDashboardDeleteCollectiveTaskTaskIdRouteImport.update({
  path: '/delete-collective-task/$taskId',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/delete-collective-task.$taskId/route.lazy').then((d) => d.Route));

const AppDashboardArchivePersonalTaskTaskIdRouteRoute = AppDashboardArchivePersonalTaskTaskIdRouteImport.update({
  path: '/archive-personal-task/$taskId',
  getParentRoute: () => AppDashboardRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/archive-personal-task.$taskId/route.lazy').then((d) => d.Route));

const AppToolsSchedulerDetailsRdvIdRouteLazyRoute = AppToolsSchedulerDetailsRdvIdRouteLazyImport.update({
  path: '/details/$rdvId',
  getParentRoute: () => AppToolsSchedulerRouteRoute,
} as any).lazy(() => import('./routes/app/tools/scheduler/details.$rdvId/route.lazy').then((d) => d.Route));

const AppToolsPredefinedMessagesUpdatePredefinedMessageIdRouteLazyRoute = AppToolsPredefinedMessagesUpdatePredefinedMessageIdRouteLazyImport.update({
  path: '/update/$predefinedMessageId',
  getParentRoute: () => AppToolsPredefinedMessagesRouteRoute,
} as any).lazy(() => import('./routes/app/tools/predefined-messages/update.$predefinedMessageId/route.lazy').then((d) => d.Route));

const AppToolsPredefinedMessagesDeletePredefinedMessageIdRouteLazyRoute = AppToolsPredefinedMessagesDeletePredefinedMessageIdRouteLazyImport.update({
  path: '/delete/$predefinedMessageId',
  getParentRoute: () => AppToolsPredefinedMessagesRouteRoute,
} as any).lazy(() => import('./routes/app/tools/predefined-messages/delete.$predefinedMessageId/route.lazy').then((d) => d.Route));

const AppToolsEmailsEmailIdReplyRouteLazyRoute = AppToolsEmailsEmailIdReplyRouteLazyImport.update({
  path: '/reply',
  getParentRoute: () => AppToolsEmailsEmailIdRouteLazyRoute,
} as any).lazy(() => import('./routes/app/tools/emails/$emailId/reply/route.lazy').then((d) => d.Route));

const AppProductsProductIdManageCreateVersionRouteLazyRoute = AppProductsProductIdManageCreateVersionRouteLazyImport.update({
  path: '/create-version',
  getParentRoute: () => AppProductsProductIdManageRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/manage/create-version/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdTaskEmailTaskIdRouteLazyRoute = AppEnterprisesEnterpriseIdTaskEmailTaskIdRouteLazyImport.update({
  path: '/task-email/$taskId',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/task-email.$taskId/route.lazy').then((d) => d.Route));
...
const AppEnterprisesEnterpriseIdRenameGedObjectObjectRelativePathRouteLazyRoute =
  AppEnterprisesEnterpriseIdRenameGedObjectObjectRelativePathRouteLazyImport.update({
    ...
    getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
  } as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/rename-ged-object.$objectRelativePath/route.lazy').then((d) => d.Route));
...
const AppEnterprisesEnterpriseIdDeleteGedObjectObjectRelativePathRouteLazyRoute =
  AppEnterprisesEnterpriseIdDeleteGedObjectObjectRelativePathRouteLazyImport.update({
    ...
    getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
  } as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/delete-ged-object.$objectRelativePath/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdAddressBookCreateRouteLazyRoute = AppEnterprisesEnterpriseIdAddressBookCreateRouteLazyImport.update({
  path: '/create',
  getParentRoute: () => AppEnterprisesEnterpriseIdAddressBookRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/address-book/create/route.lazy').then((d) => d.Route));

const AppDashboardTaskEmailTaskIdReplyRouteLazyRoute = AppDashboardTaskEmailTaskIdReplyRouteLazyImport.update({
  path: '/reply',
  getParentRoute: () => AppDashboardTaskEmailTaskIdRouteRoute,
} as any).lazy(() => import('./routes/app/dashboard/task-email.$taskId/reply/route.lazy').then((d) => d.Route));

const AppToolsPredefinedTextsUpdatePredefinedTextIdRouteRoute = AppToolsPredefinedTextsUpdatePredefinedTextIdRouteImport.update({
  path: '/update/$predefinedTextId',
  getParentRoute: () => AppToolsPredefinedTextsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/predefined-texts/update.$predefinedTextId/route.lazy').then((d) => d.Route));

const AppToolsPredefinedTextsDeletePredefinedTextIdRouteRoute = AppToolsPredefinedTextsDeletePredefinedTextIdRouteImport.update({
  path: '/delete/$predefinedTextId',
  getParentRoute: () => AppToolsPredefinedTextsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/predefined-texts/delete.$predefinedTextId/route.lazy').then((d) => d.Route));

const AppToolsNewsUpdateNewsIdRouteRoute = AppToolsNewsUpdateNewsIdRouteImport.update({
  path: '/update/$newsId',
  getParentRoute: () => AppToolsNewsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/news/update.$newsId/route.lazy').then((d) => d.Route));

const AppToolsNewsDeleteNewsIdRouteRoute = AppToolsNewsDeleteNewsIdRouteImport.update({
  path: '/delete/$newsId',
  getParentRoute: () => AppToolsNewsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/news/delete.$newsId/route.lazy').then((d) => d.Route));

const AppToolsExternalLinksUpdateExternalLinkIdRouteRoute = AppToolsExternalLinksUpdateExternalLinkIdRouteImport.update({
  path: '/update/$externalLinkId',
  getParentRoute: () => AppToolsExternalLinksRouteRoute,
} as any).lazy(() => import('./routes/app/tools/external-links/update.$externalLinkId/route.lazy').then((d) => d.Route));

const AppToolsExternalLinksDeleteExternalLinkIdRouteRoute = AppToolsExternalLinksDeleteExternalLinkIdRouteImport.update({
  path: '/delete/$externalLinkId',
  getParentRoute: () => AppToolsExternalLinksRouteRoute,
} as any).lazy(() => import('./routes/app/tools/external-links/delete.$externalLinkId/route.lazy').then((d) => d.Route));

const AppToolsExternalLinksArchiveExternalLinkIdRouteRoute = AppToolsExternalLinksArchiveExternalLinkIdRouteImport.update({
  path: '/archive/$externalLinkId',
  getParentRoute: () => AppToolsExternalLinksRouteRoute,
} as any).lazy(() => import('./routes/app/tools/external-links/archive.$externalLinkId/route.lazy').then((d) => d.Route));

const AppToolsEmailsSendPredefinedMessagesRouteRoute = AppToolsEmailsSendPredefinedMessagesRouteImport.update({
  path: '/predefined-messages',
  getParentRoute: () => AppToolsEmailsSendRouteLazyRoute,
} as any).lazy(() => import('./routes/app/tools/emails_.send/predefined-messages/route.lazy').then((d) => d.Route));

const AppToolsDdnsDeleteDdnsIdRouteRoute = AppToolsDdnsDeleteDdnsIdRouteImport.update({
  path: '/delete/$ddnsId',
  getParentRoute: () => AppToolsDdnsRouteRoute,
} as any).lazy(() => import('./routes/app/tools/ddns/delete.$ddnsId/route.lazy').then((d) => d.Route));

const AppProductsProductIdManageCreateStockRouteRoute = AppProductsProductIdManageCreateStockRouteImport.update({
  path: '/create-stock',
  getParentRoute: () => AppProductsProductIdManageRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/manage/create-stock/route.lazy').then((d) => d.Route));

const AppProductsProductIdManageAddSpecificationRouteRoute = AppProductsProductIdManageAddSpecificationRouteImport.update({
  path: '/add-specification',
  getParentRoute: () => AppProductsProductIdManageRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/manage/add-specification/route.lazy').then((d) => d.Route));

const AppProductsProductIdManageAddAssociatedProductRouteRoute = AppProductsProductIdManageAddAssociatedProductRouteImport.update({
  path: '/add-associated-product',
  getParentRoute: () => AppProductsProductIdManageRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/manage/add-associated-product/route.lazy').then((d) => d.Route));

const AppProductsProductIdInformationsRenameGedObjectRouteRoute = AppProductsProductIdInformationsRenameGedObjectRouteImport.update({
  path: '/rename-ged-object',
  getParentRoute: () => AppProductsProductIdInformationsRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/informations/rename-ged-object/route.lazy').then((d) => d.Route));

const AppProductsProductIdInformationsImportGedFilesRouteRoute = AppProductsProductIdInformationsImportGedFilesRouteImport.update({
  path: '/import-ged-files',
  getParentRoute: () => AppProductsProductIdInformationsRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/informations/import-ged-files/route.lazy').then((d) => d.Route));

const AppProductsProductIdInformationsDeleteGedObjectRouteRoute = AppProductsProductIdInformationsDeleteGedObjectRouteImport.update({
  path: '/delete-ged-object',
  getParentRoute: () => AppProductsProductIdInformationsRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/informations/delete-ged-object/route.lazy').then((d) => d.Route));

const AppProductsProductIdInformationsCreateLifesheetCommentRouteRoute = AppProductsProductIdInformationsCreateLifesheetCommentRouteImport.update({
  path: '/create-lifesheet-comment',
  getParentRoute: () => AppProductsProductIdInformationsRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/informations/create-lifesheet-comment/route.lazy').then((d) => d.Route));

const AppProductsProductIdInformationsCreateGedDirectoryRouteRoute = AppProductsProductIdInformationsCreateGedDirectoryRouteImport.update({
  path: '/create-ged-directory',
  getParentRoute: () => AppProductsProductIdInformationsRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/informations/create-ged-directory/route.lazy').then((d) => d.Route));

const AppProductsSerialNumbersDeleteSerialNumberIdRouteRoute = AppProductsSerialNumbersDeleteSerialNumberIdRouteImport.update({
  path: '/delete/$serialNumberId',
  getParentRoute: () => AppProductsSerialNumbersRouteRoute,
} as any).lazy(() => import('./routes/app/products/serial-numbers/delete.$serialNumberId/route.lazy').then((d) => d.Route));

const AppProductsSerialNumbersCreateRmaSerialNumberIdRouteRoute = AppProductsSerialNumbersCreateRmaSerialNumberIdRouteImport.update({
  path: '/create-rma/$serialNumberId',
  getParentRoute: () => AppProductsSerialNumbersRouteRoute,
} as any).lazy(() => import('./routes/app/products/serial-numbers/create-rma.$serialNumberId/route.lazy').then((d) => d.Route));

const AppFaqGedFaqIdImportFilesRouteRoute = AppFaqGedFaqIdImportFilesRouteImport.update({
  path: '/import-files',
  getParentRoute: () => AppFaqGedFaqIdRouteRoute,
} as any).lazy(() => import('./routes/app/faq/ged.$faqId/import-files/route.lazy').then((d) => d.Route));

const AppFaqGedFaqIdCreateDirectoryRouteRoute = AppFaqGedFaqIdCreateDirectoryRouteImport.update({
  path: '/create-directory',
  getParentRoute: () => AppFaqGedFaqIdRouteRoute,
} as any).lazy(() => import('./routes/app/faq/ged.$faqId/create-directory/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdUpdateContactContactIdRouteRoute = AppEnterprisesEnterpriseIdUpdateContactContactIdRouteImport.update({
  path: '/update-contact/$contactId',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/update-contact.$contactId/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdUpdateContactPasswordContactIdRouteRoute = AppEnterprisesEnterpriseIdUpdateContactPasswordContactIdRouteImport.update({
  path: '/update-contact-password/$contactId',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/update-contact-password.$contactId/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdSendEmailToContactContactIdRouteRoute = AppEnterprisesEnterpriseIdSendEmailToContactContactIdRouteImport.update({
  path: '/send-email-to-contact/$contactId',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/send-email-to-contact.$contactId/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdDeleteContactContactIdRouteRoute = AppEnterprisesEnterpriseIdDeleteContactContactIdRouteImport.update({
  path: '/delete-contact/$contactId',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/delete-contact.$contactId/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdCreateContactBusinessContactIdRouteRoute = AppEnterprisesEnterpriseIdCreateContactBusinessContactIdRouteImport.update({
  path: '/create-contact-business/$contactId',
  getParentRoute: () => AppEnterprisesEnterpriseIdRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/create-contact-business.$contactId/route.lazy').then((d) => d.Route));

const AppToolsSchedulerDetailsRdvIdUpdateRouteLazyRoute = AppToolsSchedulerDetailsRdvIdUpdateRouteLazyImport.update({
  path: '/update',
  getParentRoute: () => AppToolsSchedulerDetailsRdvIdRouteLazyRoute,
} as any).lazy(() => import('./routes/app/tools/scheduler/details.$rdvId/update/route.lazy').then((d) => d.Route));

const AppToolsSchedulerDetailsRdvIdDeleteRouteLazyRoute = AppToolsSchedulerDetailsRdvIdDeleteRouteLazyImport.update({
  path: '/delete',
  getParentRoute: () => AppToolsSchedulerDetailsRdvIdRouteLazyRoute,
} as any).lazy(() => import('./routes/app/tools/scheduler/details.$rdvId/delete/route.lazy').then((d) => d.Route));

const AppFaqGedFaqIdRenameItemRelativePathRouteLazyRoute = AppFaqGedFaqIdRenameItemRelativePathRouteLazyImport.update({
  path: '/rename/$itemRelativePath',
  getParentRoute: () => AppFaqGedFaqIdRouteRoute,
} as any).lazy(() => import('./routes/app/faq/ged.$faqId/rename.$itemRelativePath/route.lazy').then((d) => d.Route));

const AppFaqGedFaqIdDeleteItemRelativePathRouteLazyRoute = AppFaqGedFaqIdDeleteItemRelativePathRouteLazyImport.update({
  path: '/delete/$itemRelativePath',
  getParentRoute: () => AppFaqGedFaqIdRouteRoute,
} as any).lazy(() => import('./routes/app/faq/ged.$faqId/delete.$itemRelativePath/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdTaskEmailTaskIdReplyRouteLazyRoute = AppEnterprisesEnterpriseIdTaskEmailTaskIdReplyRouteLazyImport.update({
  path: '/reply',
  getParentRoute: () => AppEnterprisesEnterpriseIdTaskEmailTaskIdRouteLazyRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/task-email.$taskId/reply/route.lazy').then((d) => d.Route));

const AppProductsProductIdManageUpdateVersionVersionIdRouteRoute = AppProductsProductIdManageUpdateVersionVersionIdRouteImport.update({
  path: '/update-version/$versionId',
  getParentRoute: () => AppProductsProductIdManageRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/manage/update-version.$versionId/route.lazy').then((d) => d.Route));

const AppProductsProductIdManageUpdateStockStockIdRouteRoute = AppProductsProductIdManageUpdateStockStockIdRouteImport.update({
  path: '/update-stock/$stockId',
  getParentRoute: () => AppProductsProductIdManageRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/manage/update-stock.$stockId/route.lazy').then((d) => d.Route));

const AppProductsProductIdManageUpdateSpecificationSpecificationIdRouteRoute = AppProductsProductIdManageUpdateSpecificationSpecificationIdRouteImport.update({
  path: '/update-specification/$specificationId',
  getParentRoute: () => AppProductsProductIdManageRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/manage/update-specification.$specificationId/route.lazy').then((d) => d.Route));

const AppProductsProductIdManageStockHistoryStockIdRouteRoute = AppProductsProductIdManageStockHistoryStockIdRouteImport.update({
  path: '/stock-history/$stockId',
  getParentRoute: () => AppProductsProductIdManageRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/manage/stock-history.$stockId/route.lazy').then((d) => d.Route));
...
const AppProductsProductIdManageRemoveAssociatedProductAssociatedProductIdRouteRoute =
  AppProductsProductIdManageRemoveAssociatedProductAssociatedProductIdRouteImport.update({
    ...
    getParentRoute: () => AppProductsProductIdManageRouteRoute,
  } as any).lazy(() => import('./routes/app/products_.$productId/manage/remove-associated-product.$associatedProductId/route.lazy').then((d) => d.Route));

const AppProductsProductIdManageDeleteVersionVersionIdRouteRoute = AppProductsProductIdManageDeleteVersionVersionIdRouteImport.update({
  path: '/delete-version/$versionId',
  getParentRoute: () => AppProductsProductIdManageRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/manage/delete-version.$versionId/route.lazy').then((d) => d.Route));

const AppProductsProductIdManageDeleteStockStockIdRouteRoute = AppProductsProductIdManageDeleteStockStockIdRouteImport.update({
  path: '/delete-stock/$stockId',
  getParentRoute: () => AppProductsProductIdManageRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/manage/delete-stock.$stockId/route.lazy').then((d) => d.Route));

const AppProductsProductIdManageDeleteSpecificationSpecificationIdRouteRoute = AppProductsProductIdManageDeleteSpecificationSpecificationIdRouteImport.update({
  path: '/delete-specification/$specificationId',
  getParentRoute: () => AppProductsProductIdManageRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/manage/delete-specification.$specificationId/route.lazy').then((d) => d.Route));

const AppProductsProductIdManageAddSpecificationFilterIdRouteRoute = AppProductsProductIdManageAddSpecificationFilterIdRouteImport.update({
  path: '/$filterId',
  getParentRoute: () => AppProductsProductIdManageAddSpecificationRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/manage/add-specification/$filterId/route.lazy').then((d) => d.Route));

const AppProductsProductIdInformationsTaskEmailTaskIdRouteRoute = AppProductsProductIdInformationsTaskEmailTaskIdRouteImport.update({
  path: '/task-email/$taskId',
  getParentRoute: () => AppProductsProductIdInformationsRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/informations/task-email.$taskId/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdAddressBookUpdateAddressIdRouteRoute = AppEnterprisesEnterpriseIdAddressBookUpdateAddressIdRouteImport.update({
  path: '/update/$addressId',
  getParentRoute: () => AppEnterprisesEnterpriseIdAddressBookRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/address-book/update.$addressId/route.lazy').then((d) => d.Route));

const AppEnterprisesEnterpriseIdAddressBookDeleteAddressIdRouteRoute = AppEnterprisesEnterpriseIdAddressBookDeleteAddressIdRouteImport.update({
  path: '/delete/$addressId',
  getParentRoute: () => AppEnterprisesEnterpriseIdAddressBookRouteRoute,
} as any).lazy(() => import('./routes/app/enterprises_/$enterpriseId/address-book/delete.$addressId/route.lazy').then((d) => d.Route));

const AppProductsProductIdInformationsTaskEmailTaskIdReplyRouteLazyRoute = AppProductsProductIdInformationsTaskEmailTaskIdReplyRouteLazyImport.update({
  path: '/reply',
  getParentRoute: () => AppProductsProductIdInformationsTaskEmailTaskIdRouteRoute,
} as any).lazy(() => import('./routes/app/products_.$productId/informations/task-email.$taskId/reply/route.lazy').then((d) => d.Route));
...
export const routeTree = rootRoute.addChildren([
  ...
  AppRouteRoute.addChildren([
    AppDashboardRouteRoute.addChildren([
      ...
      AppDashboardTaskEmailTaskIdRouteRoute.addChildren([AppDashboardTaskEmailTaskIdReplyRouteLazyRoute]),
    ...
    AppToolsRouteRoute.addChildren([
      AppToolsDdnsRouteRoute.addChildren([AppToolsDdnsCreateRouteLazyRoute, AppToolsDdnsDeleteDdnsIdRouteRoute]),
      AppToolsEmailsRouteRoute.addChildren([AppToolsEmailsEmailIdRouteLazyRoute.addChildren([AppToolsEmailsEmailIdReplyRouteLazyRoute])]),
      ...
      AppToolsNewsRouteRoute.addChildren([AppToolsNewsCreateRouteLazyRoute, AppToolsNewsDeleteNewsIdRouteRoute, AppToolsNewsUpdateNewsIdRouteRoute]),
      ...
      AppToolsEmailsSendRouteLazyRoute.addChildren([AppToolsEmailsSendPredefinedMessagesRouteRoute]),
    ]),
    AppIndexRoute,
    AppEnterprisesEnterpriseIdRouteRoute.addChildren([
      ...
      AppEnterprisesEnterpriseIdTaskEmailTaskIdRouteLazyRoute.addChildren([AppEnterprisesEnterpriseIdTaskEmailTaskIdReplyRouteLazyRoute]),
    ]),
    ...
    AppProductsProductIdRouteRoute.addChildren([
      AppProductsProductIdInformationsRouteRoute.addChildren([
        ...
        AppProductsProductIdInformationsTaskEmailTaskIdRouteRoute.addChildren([AppProductsProductIdInformationsTaskEmailTaskIdReplyRouteLazyRoute]),
      ]),
      AppProductsProductIdManageRouteRoute.addChildren([
        AppProductsProductIdManageAddAssociatedProductRouteRoute,
        AppProductsProductIdManageAddSpecificationRouteRoute.addChildren([AppProductsProductIdManageAddSpecificationFilterIdRouteRoute]),
  ...
  AuthRouteRoute.addChildren([AuthForgotPasswordRouteLazyRoute, AuthLoginRouteLazyRoute, AuthIndexRoute, AuthResetPasswordTokenRouteLazyRoute]),
]);
