...
type BusinessModalComponentQuotationComponentDeleteSubquotationModalComponentProps = Readonly<{
  business: BusinessResponseDto;
  quotation: BusinessQuotationResponseDto;
  subQuotation: BusinessSubQuotationResponseDto;
  onClose: () => void;
}>;
export default function BusinessModalComponentQuotationComponentDeleteSubquotationModalComponent({
  business,
  quotation,
  subQuotation,
  onClose,
}: BusinessModalComponentQuotationComponentDeleteSubquotationModalComponentProps) {
