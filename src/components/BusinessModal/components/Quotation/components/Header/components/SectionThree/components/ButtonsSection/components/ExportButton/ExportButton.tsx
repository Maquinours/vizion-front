...
type BusinessModalComponentQuotationComponentHeaderComponentSectionThreeComponentButtonsSectionComponentExportButtonProps = Readonly<{
  business: BusinessResponseDto;
  quotation: BusinessQuotationResponseDto;
}>;
export default function BusinessModalComponentQuotationComponentHeaderComponentSectionThreeComponentButtonsSectionComponentExportButton({
  business,
  quotation,
}: BusinessModalComponentQuotationComponentHeaderComponentSectionThreeComponentButtonsSectionComponentExportButtonProps) {
  ...
  return (
    <button type="button" onClick={() => mutate()} disabled={isPending} className="btn btn-primary">
