...
type BusinessModalComponentQuotationComponentHeaderComponentSectionThreeComponentAddLineSectionComponentProps = Readonly<{
  business: BusinessResponseDto;
  quotation: BusinessQuotationResponseDto;
}>;
export default function BusinessModalComponentQuotationComponentHeaderComponentSectionThreeComponentAddLineSectionComponent({
  business,
  quotation,
}: BusinessModalComponentQuotationComponentHeaderComponentSectionThreeComponentAddLineSectionComponentProps) {
