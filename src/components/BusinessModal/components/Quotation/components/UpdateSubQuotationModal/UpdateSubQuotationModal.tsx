...
type BusinessModalComponentQuotationComponentUpdateSubquotationModalComponentProps = Readonly<{
  quotation: BusinessQuotationResponseDto;
  subquotation: BusinessSubQuotationResponseDto;
  onClose: () => void;
}>;
export default function BusinessModalComponentQuotationComponentUpdateSubquotationModalComponent({
  quotation,
  subquotation,
  onClose,
}: BusinessModalComponentQuotationComponentUpdateSubquotationModalComponentProps) {
