...
type BusinessModalComponentQuotationComponentUpdateDetailModalComponentProps = Readonly<{
  business: BusinessResponseDto;
  quotation: BusinessQuotationResponseDto;
  detail: BusinessQuotationDetailsResponseDto;
  onClose: () => void;
}>;
export default function BusinessModalComponentQuotationComponentUpdateDetailModalComponent({
  business,
  quotation,
  detail,
  onClose,
}: BusinessModalComponentQuotationComponentUpdateDetailModalComponentProps) {
