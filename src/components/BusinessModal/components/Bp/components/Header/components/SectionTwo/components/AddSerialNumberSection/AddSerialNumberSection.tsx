...
type BusinessModalComponentBpComponentHeaderComponentSectionTwoComponentAddSerialNumberSectionComponentProps = Readonly<{
  business: BusinessResponseDto;
  bp: BusinessBpResponseDto;
}>;
export default function BusinessModalComponentBpComponentHeaderComponentSectionTwoComponentAddSerialNumberSectionComponent({
  business,
  bp,
}: BusinessModalComponentBpComponentHeaderComponentSectionTwoComponentAddSerialNumberSectionComponentProps) {
  ...
  const { mutate } = useMutation({
    ...
    onSuccess: ({ detail, serial }) => {
      ...
      queryClient.invalidateQueries(queries['business-bps'].detail._ctx.byBusinessId(business.id));
