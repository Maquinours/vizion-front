...
type BusinessModalComponentDashboardComponentUpdateResponsibleModalComponentProps = Readonly<{
  business: BusinessResponseDto;
  onClose: () => void;
}>;
export default function BusinessModalComponentDashboardComponentUpdateResponsibleModalComponent({
  business,
  onClose,
}: BusinessModalComponentDashboardComponentUpdateResponsibleModalComponentProps) {
