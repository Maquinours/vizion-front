...
type BusinessModalComponentDashboardComponentEmailModalComponentProps = Readonly<{
  emailId: string;
  onClose: () => void;
}>;
export default function BusinessModalComponentDashboardComponentEmailModalComponent({
  emailId,
  onClose,
}: BusinessModalComponentDashboardComponentEmailModalComponentProps) {
