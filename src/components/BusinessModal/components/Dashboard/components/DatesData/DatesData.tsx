...
type BusinessModalComponentDashboardComponentDatesDataComponentProps = Readonly<{
  business: BusinessResponseDto;
}>;
export default function BusinessModalComponentDashboardComponentDatesDataComponent({
  business,
}: BusinessModalComponentDashboardComponentDatesDataComponentProps) {
