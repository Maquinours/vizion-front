...
type BusinessModalComponentArcComponentHeaderComponentSectionTwoComponentProps = Readonly<{
...
export default function BusinessModalComponentArcComponentHeaderComponentSectionTwoComponent({
  business,
  arc,
  hideReferencesPrices,
  setHideReferencesPrices,
}: BusinessModalComponentArcComponentHeaderComponentSectionTwoComponentProps) {
  ...
  const { mutate, isPending } = useMutation({
    ...
    onSuccess: (data) => {
      ...
      queryClient.setQueryData<BusinessArcResponseDto>(queries['business-ARCs'].detail._ctx.byBusinessId(business.id).queryKey, data);
      ...
      <div className={styles._two}>
        <form onSubmit={onSubmit}>
          ...
          <div className={styles.actions_container}>
            ...
            <button type="button" className="btn btn-primary-light" onClick={() => setHideReferencesPrices((hideReferencesPrices) => !hideReferencesPrices)}>
