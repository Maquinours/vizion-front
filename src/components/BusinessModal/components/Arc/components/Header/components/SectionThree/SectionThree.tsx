...
type BusinessModalComponentArcComponentHeaderComponentSectionThreeComponentProps = Readonly<{
  business: BusinessResponseDto;
  arc: BusinessArcResponseDto;
}>;
export default function BusinessModalComponentArcComponentHeaderComponentSectionThreeComponent({
  business,
  arc,
}: BusinessModalComponentArcComponentHeaderComponentSectionThreeComponentProps) {
