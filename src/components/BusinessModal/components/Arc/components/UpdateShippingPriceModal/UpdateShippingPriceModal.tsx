...
type BusinessModalComponentArcComponentUpdateShippingPriceModalComponentProps = Readonly<{
  business: BusinessResponseDto;
  arc: BusinessArcResponseDto;
  onClose: () => void;
}>;
export default function BusinessModalComponentArcComponentUpdateShippingPriceModalComponent({
  business,
  arc,
  onClose,
}: BusinessModalComponentArcComponentUpdateShippingPriceModalComponentProps) {
