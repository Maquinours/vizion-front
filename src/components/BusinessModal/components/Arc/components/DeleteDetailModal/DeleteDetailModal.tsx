...
type BusinessModalComponentArcComponentDeleteDetailModalComponentProps = Readonly<{
  business: BusinessResponseDto;
  arc: BusinessArcResponseDto;
  detail: BusinessArcDetailsResponseDto;
  onClose: () => void;
}>;
export default function BusinessModalComponentArcComponentDeleteDetailModalComponent({
  business,
  arc,
  detail,
  onClose,
}: BusinessModalComponentArcComponentDeleteDetailModalComponentProps) {
