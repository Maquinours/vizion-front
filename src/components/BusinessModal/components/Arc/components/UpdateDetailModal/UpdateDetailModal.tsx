...
type BusinessModalComponentArcComponentUpdateDetailModalComponentProps = Readonly<{
  business: BusinessResponseDto;
  arc: BusinessArcResponseDto;
  detail: BusinessArcDetailsResponseDto;
  onClose: () => void;
}>;
export default function BusinessModalComponentArcComponentUpdateDetailModalComponent({
  business,
  arc,
  detail,
  onClose,
}: BusinessModalComponentArcComponentUpdateDetailModalComponentProps) {
  ...
  const { mutate, isPending } = useMutation({
    ...
    onSuccess: (data) => {
      queryClient.invalidateQueries({ queryKey: queries['business-arc-details'].detail._ctx.byId(detail.id).queryKey });
      queryClient.invalidateQueries({ queryKey: queries['business-ARCs'].detail._ctx.byBusinessId(business.id).queryKey });
