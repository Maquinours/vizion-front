...
type BusinessModalComponentCreateAssistanceModalComponentProps = Readonly<{
  business: BusinessResponseDto;
  isOpen: boolean;
  onClose: () => void;
}>;
export default function BusinessModalComponentCreateAssistanceModalComponent({
  business,
  isOpen,
  onClose,
}: BusinessModalComponentCreateAssistanceModalComponentProps) {
  ...
  const { mutate, isPending } = useMutation({
    ...
    onSuccess: async (technicalSupport) => {
      ...
      // await navigate({ to: '/app/businesses-rma/business/$businessId/assistance/$assistanceId', params: { assistanceId: technicalSupport.id } }); // TODO: go to assistance modal
