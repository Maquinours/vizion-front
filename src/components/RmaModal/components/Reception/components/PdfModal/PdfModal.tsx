...
type RmaModalComponentReceptionComponentPdfModalComponentProps = Readonly<{
  rma: AssistanceResponseDto;
  onClose: () => void;
}>;
export default function RmaModalComponentReceptionComponentPdfModalComponent({ rma, onClose }: RmaModalComponentReceptionComponentPdfModalComponentProps) {
