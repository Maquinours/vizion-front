...
import { createRmaReceptionDetail } from '../../../../../../utils/api/rmaReceptionDetail';
...
// const routeApi = getRouteApi('/app/businesses-rma_/rma/$rmaId/reception/create-detail');
...
type RmaModalComponentReceptionComponentCreateDetailModalViewProps = Readonly<{
  rma: AssistanceResponseDto;
  onClose: () => void;
}>;
export default function RmaModalComponentReceptionComponentCreateDetailModalView({
  rma,
  onClose,
}: RmaModalComponentReceptionComponentCreateDetailModalViewProps) {
