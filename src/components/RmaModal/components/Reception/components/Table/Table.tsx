...
import RmaModalComponentReceptionComponentTableComponentContextMenuComponent from './ContextMenu/ContextMenu';
...
type RmaModalComponentReceptionComponentTableComponentProps = Readonly<{
  rma: AssistanceResponseDto;
}>;
export default function RmaModalComponentReceptionComponentTableComponent({ rma }: RmaModalComponentReceptionComponentTableComponentProps) {
  ...
  return (
    <>
      ...
      <RmaModalComponentReceptionComponentTableComponentContextMenuComponent
