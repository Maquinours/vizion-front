...
type RmaModalComponentReceptionComponentTableComponentContextMenuComponentProps = Readonly<{
...
export default function RmaModalComponentReceptionComponentTableComponentContextMenuComponent({
  anchorElement,
  setAnchorElement,
  item,
}: RmaModalComponentReceptionComponentTableComponentContextMenuComponentProps) {
