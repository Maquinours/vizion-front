...
type RmaModalComponentDeliveryComponentTravelVoucherModalComponentShowModalComponentProps = Readonly<{
  show: boolean;
  onClose: () => void;
  data: Array<File> | undefined;
}>;
export default function RmaModalComponentDeliveryComponentTravelVoucherModalComponentShowModalComponent({
  show,
  onClose,
  data,
}: RmaModalComponentDeliveryComponentTravelVoucherModalComponentShowModalComponentProps) {
