...
import { generateTravelVoucher } from '../../../../../../../../views/App/views/Enterprises/views/CreateContactTravelVoucherModal/components/StepOne/utils/api/travelVoucher';
...
type RmaModalComponentDeliveryComponentTravelVoucherModalComponentFormModalComponentProps = Readonly<{
  rma: AssistanceResponseDto;
  show: boolean;
  onClose: () => void;
  onGenerated: (data: Array<File>) => void;
}>;
export default function RmaModalComponentDeliveryComponentTravelVoucherModalComponentFormModalComponent({
  rma,
  show,
  onClose,
  onGenerated,
}: RmaModalComponentDeliveryComponentTravelVoucherModalComponentFormModalComponentProps) {
  const {
    register,
    setValue,
    handleSubmit,
