...
type EnterpriseModalComponentCategoryComponentProps = Readonly<{
  enterprise: EnterpriseResponseDto;
}>;
export default function EnterpriseModalComponentCategoryComponent({ enterprise }: EnterpriseModalComponentCategoryComponentProps) {
  return (
