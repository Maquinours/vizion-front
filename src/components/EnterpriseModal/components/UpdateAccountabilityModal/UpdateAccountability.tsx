...
type EnterpriseModalComponentUpdateAccountabilityModalComponentProps = Readonly<{
  enterprise: EnterpriseResponseDto;
  onClose: () => void;
}>;
export default function EnterpriseModalComponentUpdateAccountabilityModalComponent({
  enterprise,
  onClose,
}: EnterpriseModalComponentUpdateAccountabilityModalComponentProps) {
