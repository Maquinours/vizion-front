...
type EnterpriseModalComponentCreateBusinessModalComponentProps = Readonly<{
  enterprise: EnterpriseResponseDto;
  contact: ProfileResponseDto;
  onClose: () => void;
  openBusinessModal: (business: BusinessResponseDto) => void;
}>;
export default function EnterpriseModalComponentCreateBusinessModalComponent({
  enterprise,
  contact,
  onClose,
  openBusinessModal,
}: EnterpriseModalComponentCreateBusinessModalComponentProps) {
