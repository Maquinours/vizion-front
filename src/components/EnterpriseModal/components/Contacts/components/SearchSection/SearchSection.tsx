...
type EnterpriseModalComponentContactsComponentSearchSectionComponentProps = Readonly<{
  search: string | undefined;
  setSearch: (search: string | undefined) => void;
  setPage: (page: number) => void;
}>;
export default function EnterpriseModalComponentContactsComponentSearchSectionComponent({
  search,
  setSearch,
  setPage,
}: EnterpriseModalComponentContactsComponentSearchSectionComponentProps) {
