...
type AssistanceModalComponentExpectedTimeCardComponentProps = Readonly<{
  assistance: TechnicalSupportResponseDto;
}>;
export default function AssistanceModalComponentExpectedTimeCardComponent({ assistance }: AssistanceModalComponentExpectedTimeCardComponentProps) {
