...
type AssistanceModalComponentCreateFaqModalComponentProps = Readonly<{
  business: BusinessResponseDto;
  assistance: TechnicalSupportResponseDto;
  onClose: () => void;
}>;
export default function AssistanceModalComponentCreateFaqModalComponent({
  business,
  assistance,
  onClose,
}: AssistanceModalComponentCreateFaqModalComponentProps) {
                ...
                <div className={styles.second_grid}>
                  ...
                  <div className={styles.form_group}>
                    <label className={styles.label}>
                      Assistance {assistance.name || 'Sans nom'} ({assistance.businessNumber})
                    </label>
                  </div>
                </div>
              </div>
