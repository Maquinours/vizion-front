...
type AssistanceModalComponentNoBilledTimeCardComponentProps = Readonly<{
  assistance: TechnicalSupportResponseDto;
  onEditButtonClick: () => void;
}>;
export default function AssistanceModalComponentNoBilledTimeCardComponent({
  assistance,
  onEditButtonClick,
}: AssistanceModalComponentNoBilledTimeCardComponentProps) {
